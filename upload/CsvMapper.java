...
public class CsvMapper {
    ...
    public static final int EDGE_WEIGHT = 4;
    public static final int TO_NODE_TYPE = 5;
    public static final int TO_NODE_SUBTYPE = 6;
    public static final int TO_NODE_VALUE = 7;
}
